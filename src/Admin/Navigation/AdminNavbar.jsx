    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + isLargeScreen, backgroundColor: 'rgb(0, 0, 22)' }}>
        <Toolbar>
          ...
          <Avatar alt="Zosh" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.postermywall.com%2Findex.php%2Fart%2Ftemplate%2F0a279abdd76be76cc852e4ac959cc5f4%2Fclothing-logo-design-template&psig=AOvVaw1IfL7wpmB-k3lpUnXEyb9A&ust=1703229861346000&source=images&cd=vfe&ved=0CBIQjRxqFwoTCKCQ6Oz_n4MDFQAAAAAdAAAAABAE" />
          <Search>
            <SearchIconWrapper>
              <SearchIcon />
            </SearchIconWrapper>
